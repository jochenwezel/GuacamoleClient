            ...
            set
            {
                ...
                switch (value)
                {
                    case KeyboardCaptureMode.GrabbingEnabled_ShowKeyboardShortcutInfo:
                        this.HintStopWebcontrol2FocusShortcut!.Text = LocalizedString(LocalizationKey.Tip_CtrlAltScroll_StopKeyboardGrabbingOfGuacamoleWindow);
                        this.HintStopWebcontrol2FocusShortcut!.Visible = true;
                        break;
                    case KeyboardCaptureMode.GrabbingDisabled_ShowKeyboardShortcutInfo:
                        this.HintStopWebcontrol2FocusShortcut!.Text = LocalizedString(LocalizationKey.Tip_CtrlAltScroll_StartKeyboardGrabbingOfGuacamoleWindow);
                        this.HintStopWebcontrol2FocusShortcut!.Visible = true;
                        break;
