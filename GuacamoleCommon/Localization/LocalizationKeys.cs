namespace GuacamoleClient.Common.Localization
{
    ...
    public enum LocalizationKeys
    {
        ...
        Menu_GpuHardwareAccelerationDisabled,
        Menu_RestartRequired_Title,
        Menu_RestartRequired_Text,
        Menu_Help,
        Menu_HelpRdpResize,
        Menu_About,
        ...
        AddEdit_Label_LocalWebViewCache,
        AddEdit_Radio_DisableLocalCacheRecommended,
        AddEdit_Radio_EnableLocalCache,
        AddEdit_Info_LocalCacheDisabled,
        AddEdit_Warning_LocalCacheEnabled,
        AddEdit_Button_Save,
